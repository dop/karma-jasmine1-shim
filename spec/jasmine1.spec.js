...
describe('A spy', function() {
  ...
  it('has argsForCall', function () {
    expect(foo.setBar.argsForCall[0][0]).toBe(123);
  });

  it('knows about the second call', function () {
    expect(foo.setBar.calls[1].args[1]).toBe('another param');
  });
});
